...
if (xxHash_FOUND)
  ...
  if (xxHash_SOURCE_DIR)
    cmake_path(GET xxHash_SOURCE_DIR PARENT_PATH xxHash_SOURCE_DIR) # drop "cmake_unofficial"
    set(XXHASH_INCLUDE_DIR ${xxHash_SOURCE_DIR})
#    add_library(xxHash ALIAS xxHash::xxhash)
    add_library(xxHash INTERFACE)
#    set_property(TARGET xxHash APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${xxHash_SOURCE_DIR})
    target_compile_definitions(xxHash INTERFACE XXH_INLINE_ALL)
