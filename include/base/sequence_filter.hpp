 ...
 */
template <typename TContainer, typename Predicate, typename TElement = meta::element_type<TContainer>,
...
sequence_filter(const TContainer, Predicate&&)
    -> sequence_filter<typename std::remove_reference<TContainer>::type, Predicate,
                       typename meta::element_type<TContainer>, typename TContainer::const_iterator>;
// clang-format on
#endif
